...
function Home() {
  ...
  return (
    <div ref={containerRef} className="min-h-screen bg-cover bg-center" style={{ backgroundImage: "url('bg.jpg')" }}>
      <div className="flex flex-col items-center justify-center py-10">
        ...
        <div className="flex flex-col md:flex-row w-full max-w-6xl space-x-0 md:space-x-8">
          <div className="bg-white rounded-3xl mt-8 p-8 shadow-xl w-full md:w-1/2 transition-transform transform hover-animate">
          ...
          <div className="flex flex-col items-center mt-8 md:mt-0 w-full md:w-1/2 hover-animate">
